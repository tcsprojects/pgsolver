...
(* OASIS_START *)
(* DO NOT EDIT (digest: a5c8538b0420a7fc68a6fe5bf403fa3a) *)
(*
...
let setup_t =
  {
            ...
            [
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "paritygame/Arrayparitygame";
                           "paritygame/Mapparitygame";
                           ...
                           "solvers/stratimpralgs/Switch_friedmann";
                           ...
                           "generators/policyiter/generators/Zadehexpish";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "lbfinder.ml"});
               Executable
                 ({
                     cs_name = "cycletester-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "cycletester.ml"})
            ];
     ...
     oasis_digest = Some "r\\\154\149n\146\031\127|+f\2259'\001\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
