...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0e35dbb04a42653f24c118597e2f594c) *)
(*
...
let setup_t =
  {
            ...
            [
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "solvers/Viasat";
                           "solvers/Stratimprlowerboundanalyze";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "analyzepolicy.ml"});
               Executable
                 ({
                     cs_name = "itersat-bin";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\243\171k\157\202\229\022\220\005H'\246Z?\206\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
