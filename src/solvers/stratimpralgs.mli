...
val node_valuation_total_ordering: paritygame -> node_total_ordering_fun -> game_valuation -> int -> int -> int

val best_decision_by_ordering: paritygame -> (int -> int -> int) -> int -> int

val empty_descending_relevance_ordered_set: paritygame -> node_total_ordering_fun -> int TreeSet.t
