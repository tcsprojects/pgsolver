...
val solve_single_player_scc: paritygame -> int -> solution * strategy

val solve_single_parity_scc: paritygame -> int -> solution * strategy
...
val compute_winning_nodes_for_direct: paritygame -> int -> solution * strategy

val compute_winning_nodes_direct: paritygame -> strategy -> int -> int list