...
val solve_single_player_scc: paritygame -> Pgplayer.player -> solution * strategy

val solve_single_parity_scc: paritygame -> Pgplayer.player -> solution * strategy
...
val compute_winning_nodes_for_direct: paritygame -> Pgplayer.player -> solution * strategy

val compute_winning_nodes_direct: paritygame -> strategy -> Pgplayer.player -> Pgnode.node list
